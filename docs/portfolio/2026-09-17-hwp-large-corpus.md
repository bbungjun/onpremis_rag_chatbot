...
2026-09-18 후속 작업에서 기본 생성 형태를 단일 HWP 규정집으로 바꾸었다. 이 문서의 1,000개 파일 측정은 `--layout split` 결과로 보존한다. 단일 파일의 별도 증거는 `docs/portfolio/2026-09-18-single-hwp-volume.md`에 기록한다.
